package com.rime.portfolioproject.domain

import com.rime.portfolioproject.domain.constant.SkillType
import com.rime.portfolioproject.domain.entity.Achivement
import com.rime.portfolioproject.domain.entity.Experience
import com.rime.portfolioproject.domain.entity.ExperienceDetail
...
class DataInitializer(
    ...
    private val projectRepository: ProjectRespository,
    ...
    fun initialize() {
        ...
        // achivement 초기화
        val achivements = mutableListOf<Achivement>(
            Achivement(
        ...
        achievementRepository.saveAll(achivements)
        ...
        introductions.addAll(introductions)
        ...
        val links = mutableListOf<Link>(
            ...
            Link(
                name = "Linkedin",
                content = "http://www.linkedin.com/in/bokeunjeong",
                isActive = true
            )
        )
